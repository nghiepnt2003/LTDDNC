      ...
      >
        ...
        <View style={{ height: 165 }}>
          <Text style={{ color: "#000" }} className="tracking-wider py-3">
            {product?.description
              ? product.description
              : "Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci culpa nostrum dolor, eaque iste totam ex labore omnis est, laboriosam voluptas minus itaque ipsa, iusto molestias unde numquam doloribus pariatur?"}
          </Text>
        </View>
      </View>
    </View>
